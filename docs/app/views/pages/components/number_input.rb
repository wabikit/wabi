          ...
          render ::Components::Site::Layout.new(title: "Number Input", chrome: :full) do
            main(class: "container mx-auto py-12 px-4 max-w-3xl") do
              ...
              render ::Components::Site::ComponentPreview.new(source: <<~RUBY) do
                render Components::UI::NumberInput.new(name: "quantity", value: 1, min: 0, class: "w-44")
              RUBY
                render ::Components::UI::NumberInput.new(name: "quantity", value: 1, min: 0, class: "w-44")
              end
              ...
              render ::Components::Site::ComponentPreview.new(source: <<~RUBY) do
                render Components::UI::NumberInput.new(
                  ...
                  format: :currency, currency: "USD", class: "w-44"
                )
              RUBY
                render ::Components::UI::NumberInput.new(
                  name: "price", value: 19.99, step: 0.01, precision: 2,
              ...
              render ::Components::Site::ComponentPreview.new(source: <<~RUBY) do
                render Components::UI::NumberInput.new(name: "rating", value: 3, min: 0, max: 5, step: 1, class: "w-44")
              RUBY
                render ::Components::UI::NumberInput.new(name: "rating", value: 3, min: 0, max: 5, step: 1, class: "w-44")
              end
              ...
              render ::Components::Site::ComponentPreview.new(source: <<~RUBY) do
                render Components::UI::NumberInput.new(name: "qty", value: 2, invalid: true, class: "w-44")
              RUBY
                render ::Components::UI::NumberInput.new(name: "qty", value: 2, invalid: true, class: "w-44")
              end
              ...
              render ::Components::Site::ComponentPreview.new(source: <<~RUBY) do
                render Components::UI::NumberInput.new(name: "a", value: 1, size: :sm, class: "w-40")
                render Components::UI::NumberInput.new(name: "b", value: 1, size: :md, class: "w-40")
                render Components::UI::NumberInput.new(name: "c", value: 1, size: :lg, class: "w-40")
              RUBY
