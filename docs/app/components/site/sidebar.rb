  ...
  module Site
    class Sidebar < Components::Base
      ...
      GROUPS = [
        ...
        { label: "Forms", items: %w[button checkbox color_picker combobox date_picker file_upload form input input_otp label number_input radio_group rating_group select slider switch tags_input textarea toggle toggle_group].map(&COMPONENT_LINK) },
